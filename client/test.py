...
def main() -> None:
    ...
    print(f"  gain_cb={pid.gain_cb:.4f}  bias_cb={pid.bias_cb:.4f}  egain_cb={pid.egain_cb:.4f}")
    ...
    _check_approx("gain echo",  pid.gain_cb,  1.0, 0.002)
    _check_approx("bias echo",  pid.bias_cb,  0.0, 0.01)
    _check_approx("egain echo", pid.egain_cb, 1.0, 0.002)
