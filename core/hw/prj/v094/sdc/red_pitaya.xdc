...
set_max_delay -datapath_only -from [get_pins {ps/axi_slave_gp0/rd_araddr*[*]/C}] -to [get_pins {sys_bus_interconnect/for_bus[*].inst_sys_bus_cdc/bus_m\.addr*[*]*/D}] 8.000
set_max_delay -datapath_only -from [get_pins {ps/axi_slave_gp0/wr_awaddr*[*]/C}] -to [get_pins {sys_bus_interconnect/for_bus[*].inst_sys_bus_cdc/bus_m\.addr*[*]*/D}] 8.000
set_max_delay -datapath_only -from [get_pins ps/axi_slave_gp0/rd_do*/C] -to [get_pins {sys_bus_interconnect/for_bus[*].inst_sys_bus_cdc/bus_m\.addr*[*]*/D}] 8.000
...
set_max_delay -datapath_only -from [get_pins i_hk/i_freq_meter/ref_gate_reg/C] -to [get_pins {i_hk/i_freq_meter/mes_gate_csff*[0]/D}] 8.000
